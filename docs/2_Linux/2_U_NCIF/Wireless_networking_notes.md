...
| 2.4GHz                                                          | 5GHz                                                |
| :-------------------------------------------------------------- | :-------------------------------------------------- |
| Longer Freq Waves                                               | Shorter Freq waves                                  |
| - Prorogates through solid surfaces well                        | - Less Effective penetrating solid surfaces         |
| - Good solution for long-distances                              | - Not as effective over long distances              |
| -Slower data rates                                              | - Faster data rates                                 |
| Lower data rates over longer distances                          | Higher data rates over shorter distances            |
| Fewer Channels                                                  | More Channels                                       |
| - 3 non-overlapping channels                                    | - 24 Non-overlapping                                |
|                                                                 | - Channel bonding available                         |
| Suffers from freq congestion & interference                     | Less congested than 2.4GHz freq                     |
| - Mircrowaves, cordless phones, and bluetooth operate at 2.4GHz | - Freq congestion and interference isnt a big issue |
